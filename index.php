...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.php">Kpebriki.com</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <a href="index.php" class="logo"><img src="assets/img/logoj.png" alt="" class="img-fluid"></a>
    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="hero-title mb-4">Je suis Honoré Ngoran, Dévelopeur </h1>
          <p class="hero-subtitle"><span class="typed" data-typed-items="BACK-END,FRONT-END,WEB,MOBILE"></span></p>
